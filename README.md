# Gas-turbine-open-world-fault-diagnosis
An Open-World Fault Diagnosis Method for Gas Turbines Based on Deep Evidential and Scalable Prototype Learning
...
## Quick Run
Simply run `single-attack experiment`. 
